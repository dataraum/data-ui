ALTER TABLE "meta_data"."project_members" DROP CONSTRAINT "project_members_user_id_user_email_fk";
--> statement-breakpoint
ALTER TABLE "meta_data"."projects" DROP CONSTRAINT "projects_project_owner_user_email_fk";
--> statement-breakpoint
ALTER TABLE "meta_data"."workspace" DROP CONSTRAINT "workspace_workspace_owner_user_email_fk";
--> statement-breakpoint
